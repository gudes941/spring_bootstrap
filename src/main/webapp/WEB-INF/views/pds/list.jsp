    ...
    <section class="content">
		<div class="card">
			<div class="card-header with-border">
				<button type="button" class="btn btn-primary" id="registBtn" onclick="OpenWindow('registForm.go','자료등록',800,700);">자료등록</button>
						...
						<tr style='font-size:0.85em;'>
							...
							<td id="boardTitle" style="text-align:left;max-width: 100px; overflow: hidden;
								...
								<a href="javascript:OpenWindow('detail.do?from=list&pno=${pds.pno }','상세보기',800,700);">
									<span class="col-sm-12 ">탄방고 1학년 중간고사 자료 </span>
								</a>
							</td>
							<td>
							...
							<td>강동주</td>
							<td>
								<fmt:formatDate value="2022-03-31" pattern="yyyy-MM-dd"/>
							</td>
